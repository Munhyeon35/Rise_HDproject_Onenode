...
#include "yolov8_msgs/msg/detail/objects__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const yolov8_msgs::msg::ObjTracking &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const yolov8_msgs::msg::Objects & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yolov8_msgs::msg::Objects & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        yolov8_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ObjTracking(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = yolov8_msgs::msg::Objects;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yolov8_msgs::msg::Objects *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolov8_msgs::msg::Objects *>(
    untyped_ros_message);
...
{
  return &yolov8_msgs::msg::typesupport_fastrtps_cpp::_Objects__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolov8_msgs, msg, Objects)() {
  return &yolov8_msgs::msg::typesupport_fastrtps_cpp::_Objects__handle;
}
