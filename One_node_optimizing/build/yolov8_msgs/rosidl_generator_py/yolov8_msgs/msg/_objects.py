...
class Metaclass_Objects(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if ObjTracking.__class__._TYPE_SUPPORT is None:
                ObjTracking.__class__.__import_type_support__()
...
class Objects(metaclass=Metaclass_Objects):
    ...
    _fields_and_field_types = {
        ...
        'objects': 'sequence<yolov8_msgs/ObjTracking>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['yolov8_msgs', 'msg'], 'ObjTracking')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, ObjTracking) for v in value) and
                 True), \
                "The 'objects' field must be a set or sequence and each value of type 'ObjTracking'"
        self._objects = value
