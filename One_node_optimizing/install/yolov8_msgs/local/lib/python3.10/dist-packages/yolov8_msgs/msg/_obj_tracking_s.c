...
bool yolov8_msgs__msg__obj_tracking__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yolov8_msgs.msg._obj_tracking.ObjTracking", full_classname_dest, 41) == 0);
  }
  yolov8_msgs__msg__ObjTracking * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of ObjTracking */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("yolov8_msgs.msg._obj_tracking");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObjTracking");
